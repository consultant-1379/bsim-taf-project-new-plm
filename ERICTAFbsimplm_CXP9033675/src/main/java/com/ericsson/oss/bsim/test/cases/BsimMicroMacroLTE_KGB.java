 ...
 * @author xnehmis
 */
public class BsimMicroMacroLTE_KGB extends TorTestCaseHelper implements TestCase {
    ...
    @Test(dataProvider = "newMicroMacroLTENodesKGB", dataProviderClass = BsimTestData.class, groups = { "KGB", "VCDB" })
